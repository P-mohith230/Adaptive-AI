...
function OverviewTab({ orgData, dashboardData, latestRecommendation, alerts, onUpdate, isUpdating }: TabProps) {
  ...
  const handleScrape = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://backend-production-8caff.up.railway.app/api/v1'}/organizations/${orgData.organization_id}/scrape`, {
        method: 'POST',
